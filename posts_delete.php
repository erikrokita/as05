 ...
 * description : This program deletes one assignment's details (table: posts)
 * ---------------------------------------------------------------------------
 */
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="posts_delete.php" method="post">
				<input type="hidden" name="id" value="<?php echo $id;?>"/>
				<p class="alert alert-error">Are you sure you want to delet ur post cuz u wanna take back what u said cuz ur nub?</p>
				<div class="form-actions">
					<button type="submit" class="btn btn-danger">Yes</button>
					<a class="btn" href="posts.php">No</a>
				</div>
			</form>
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo trim($eventdata['tags']) . " (" . trim($eventdata['description']) . ") ";?>
						</label>
					</div>
				</div>
