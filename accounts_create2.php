...
if ( !empty($_POST)) { // if not first time through
	...
	if ($valid) 
	{
		...
		$q = $pdo->prepare($sql);
		$q->execute(array($username,$passwordshash,$email,$description,$admin,
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="accounts_create2.php" method="post" enctype="multipart/form-data">
				...
				<div class="control-group <?php echo !empty($passwordsError)?'error':'';?>">
					...
					<div class="controls">
						<input id="passwords" name="passwords" type="password"  placeholder="Password" value="<?php echo !empty($passwords)?$passwords:'';?>">
				...
				<div class="control-group <?php echo !empty($descriptionError)?'error':'';?>">
					<label class="control-label">Account Bio</label>
					<div class="controls">
				...
				<div class="control-group <?php echo !empty($pfpError)?'error':'';?>">
